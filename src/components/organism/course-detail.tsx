				...
				<>
					<div className='mb-6'>
						...
						<div>
							...
							/>
							{courseData?.courseDescription?.facilities?.length >
								200 && (
								<button
					...
					<div className='mb-6'>
						...
						<div>
							...
							/>
							{courseData?.courseDescription?.schedule?.length >
								200 && (
								<button
						...
						<div className='flex flex-wrap justify-center'>
							...
							<div className='w-full lg:w-1/4 '>
								<aside className='w-full border rounded-lg bg-white shadow-lg p-4 sticky top-20 lg:ml-2 mt-6 lg:mt-0 grid'>
									...
									<button
										onClick={() =>
											alert('Proses beli barang dimulai!')
										}
